...
### Identifying Data_Inputs for a Particular Case Study

For a given case-study a subset of the training data inputs may be available. Those are specified and the training dataset subsetted to include only those inputs. 
...
Assuming the indicator passes both theoretical evaluate and empirical validation, it may then be used to determine stock status for the case study. 
