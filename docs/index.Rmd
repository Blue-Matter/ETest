...
### Format indicators for use with EcoTest neural networks
...
### Train and artificial neural network for the specific suite of indicators selected by the user
