...
For a given case-study only some of the data inputs (types of data) of the full training dataset may be available. The training dataset subsetted to include only those data inputs. 
